...
#define BOARD_COLOR_TRANSPARENT_R 0
#define BOARD_COLOR_TRANSPARENT_G 0
#define BOARD_COLOR_TRANSPARENT_B 0

#define POSSIBLE_MOVE_COLOR_R 0
#define POSSIBLE_MOVE_COLOR_G 255
#define POSSIBLE_MOVE_COLOR_B 100

#define ALPHA_COLOR_SEMI 60
